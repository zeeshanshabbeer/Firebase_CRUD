...
exports.create = catchAsync(async (req, res, next) => {
  ...
  req.body.forEach(function (obj) {
    try {
      const MatchRecord = doc(db, "Cricket", obj["Match Date"]);
      setDoc(
        MatchRecord,
        { Match: obj.Match },
        { Ground: obj.Ground },
        { Margin: obj.Margin },
        { Result: obj.Result },
        { "Home/Away": obj["Home/Away"] },
        { "Match Date": obj["Match Date"] },
        { "Match Month": obj["Match Month"] },
        { "Match Period": obj["Match Period"] },
        { "Match Year": obj["Match Year"] },
        { Matches: obj.Matches }
      );
      console.log("Document added ID: ", obj["Match Date"]);
    } catch (error) {
      return next(new AppError("Document not added Found", error, 400));
    }
  });
  if (MatchRecord === false) {
    return next(new AppError(" Document not added", 400));
  }
  res.status(200).json({
    status: "success",
...
exports.read = catchAsync(async (req, res, next) => {
  const docRef = doc(db, "Cricket", req.body["Match Date"]);
...
exports.delete_record = catchAsync(async (req, res, next) => {
  const docRef = doc(db, "Cricket", req.body["Match Date"]);
  const docSnap = await getDoc(docRef);
  if (docSnap.exists()) {
...
//     Result: "Won",
//     Margin: "7 wickets",
//     Match: "U.A.E. v Australia",
//     "Home/Away": "Away",
//     Ground: "Tolerance Oval",
//     "Match Date": "10/22/18",
//     "Match Month": "Oct",
//     "Match Year": "2018",
//     "Match Period": "Oct-18",
...
//     Result: "Won",
//     Margin: "59 runs",
//     Match: "Afghanistan v South Africa",
//     "Home/Away": "Away",
//     Ground: "Bridgetown",
//     "Match Date": "5/5/10",
//     "Match Month": "May",
...
//     Result: "Won",
//     Margin: "6 runs",
//     Match: "Netherlands v South Africa",
//     "Home/Away": "Away",
//     Ground: "Chattogram",
//     "Match Date": "3/27/14",
//     "Match Month": "Mar",
...
//     Result: "Won",
//     Margin: "52 runs",
//     Match: "Bangladesh v South Africa",
//     "Home/Away": "Away",
//     Ground: "Dhaka",
//     "Match Date": "7/5/15",
//     "Match Month": "Jul",
